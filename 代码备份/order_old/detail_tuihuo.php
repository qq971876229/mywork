	...
	<div class="member"> 
		...
		<div class="orderWarp">
				...
				<table class="goods-table" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td width="119" align="center">
							<?php
							if   ($rows ["state"]>0){
								echo " <a href=\"javascript:void(null)\"   class=\"W_btn_b m blue\" onclick=\"tuihuo('".$rows ["id"]."')\"><span>申请退款</span></a>";
							}
							?>
						</td>
					</tr>
			...
			<div class="user-info disnone" id="tuihuo_reason">
						<div class="zhence">
							客户享受7天无理由退货政策，15天有质量问题免费退换货政策
用户签收之日起7天内，保证退货商品完好，产品没有污迹和破损且未经使用过，商
品及商品本身包装保持云蚂蚁出售时原状且配件赠品资料等齐全，不影响二次销售，可以无理由退换货；一张订单拥有一次无理由免费退换货机会。
						</div>	
						<br/>
						<input type="hidden" name="tuihuo_orderid" />																
						退款去向:
						<select name="account_type">
							<option value="0">蚂蚁盾</option>						
							<option value="1">支付宝</option>
							<option value="2">网银</option>
						</select>&nbsp;&nbsp;&nbsp;<br/><br/>
						<span class="display_none" id="alipay">支付宝或网银帐号: <input type="text" name="account"  /><span class="tips">* 选择支付宝或网银必填</span><br/><br/></span>
						<span class="display_none" id="bankpay">银行开户行: <input type="text" name="bank_address"  /><span class="tips ">* 选择银行必填</span><br/><br/></span>
						<div class="reason">
							退货原因：<select name="reason">	
										<option value="-1">请选择</option>
										<option value="2">7天无理由退货</option>									
										<option value="1">缺货</option>										
										<option value="3">尺寸/款式不合适</option>
										<option value="4">非活动地区购买</option>
										<option value="5">商品短少</option>
										<option value="6">商品错发</option>
										<option value="7">客户误删订单</option>
										<option value="8">商品破损</option>
										<option value="9">商品质量问题</option>
										<option value="10">重复购买/支付</option>
										<option value="11">客户下错单</option>
										<option value="0">其他</option>
										
									</select>						
							<!-- 退货原因：<br/><textarea name="reason" id="reason" cols="30" rows="10"></textarea> -->							
							<span class="tips">*必填</span><br/><br/>	
						</div>
						<div class="action">
							<button type="button" class="tuihuo_submit" onclick="tuihuo_do()">提交申请</button>
							<!-- the tuihuo_do function in the file of ufun.js -->
						</div>									
			</div>
			<!-- 申请退款   end -->
